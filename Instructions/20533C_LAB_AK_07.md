...
1. Start SQL Server 2014 Management Studio, and in the  **Connect to Server** dialog box, specify the following settings (replacing server_name_ with the unique name you specified when creating your SQL Database server), and click **Connect**:
